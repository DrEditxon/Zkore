...
class MarketService:
    ...
    def _get_cache_path(self, sport_key: str) -> str:
        return os.path.join(CACHE_DIR, f"odds_{sport_key}.json")
    ...
    def get_market_probabilities(self, league_code: str, home_name: str, away_name: str) -> dict | None:
        ...
        (margin removed). Returns None if match not found or API disabled.
        """
        if not self.enabled:
            return None
